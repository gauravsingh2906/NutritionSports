...
class CustomerRepositoryImpl:CustomerRepository {
    ...
    override suspend fun updateCustomer(
        ...
        try {
            ...
            onError("Error while update a customer information: ${e.message}")
        }
    }
        ...
        try {
            ...
            if(currentUserId!=null) {
                ...
                if(existingCustomer.exists) {
                    ...
                    val updateCart = existingCart + cartItem
    ...
    override suspend fun updateCartItemQuantity(
        ...
        try {
            ...
            if(currentUserId!=null) {
                ...
                if(existingCustomer.exists) {
                    val existingCart = existingCustomer.get<List<CartItem>>("cart")
                    val updateCart = existingCart.map { cartItem->
                        if(cartItem.id == id) {
    ...
    override suspend fun deleteCartItem(
        ...
        if(currentUserId!=null) {
            ...
            if(existingCustomer.exists) {
                val existingCart = existingCustomer.get<List<CartItem>>("cart")
                val updateCart = existingCart.filterNot {
                    it.id == id
                }
